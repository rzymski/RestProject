...
public class FlightWithLinksController : ControllerBase
{
    private readonly ILogger<FlightWithLinksController> logger;
    private readonly IFlightService flightService;
    private LinkGenerator _linkGenerator;

    public FlightWithLinksController(ILogger<FlightWithLinksController> logger, IFlightService flightService, LinkGenerator linkGenerator)
    {
        this.logger = logger;
