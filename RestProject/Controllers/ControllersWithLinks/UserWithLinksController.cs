...
public class UserWithLinksController : ControllerBase
{
    private readonly ILogger<UserWithLinksController> logger;
    private readonly IUserService userService;
    private LinkGenerator _linkGenerator;

    public UserWithLinksController(ILogger<UserWithLinksController> logger, IUserService userService, LinkGenerator linkGenerator)
    {
        this.logger = logger;
    ...
    private List<Link> CreateLinksForUser(int id, string login, [CallerMemberName] string actionName = "")
    {
        ...
        {
            new Link(_linkGenerator.GetUriByAction(HttpContext, nameof(GetOne), values: new { id }), actionName == nameof(GetOne) ? "self" : "get_user", "GET"),
            new Link(_linkGenerator.GetUriByAction(HttpContext, nameof(GetByLogin), values: new { login }), actionName == nameof(GetByLogin) ? "self" : "get_user", "GET"),
