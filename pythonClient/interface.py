    ...
    def manageMainList(self, flightsData=None, reservationsData=None):
        ...
        if reservationsData:
            ...
            for reservation in reservationsData:
                self.mainReservationList.insert('', END, values=(reservation["flightId"], reservation['reservationId'], reservation['flightCode'], reservation['airports'], reservation['dates'], reservation['seats']))
